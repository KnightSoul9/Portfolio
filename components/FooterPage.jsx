...
export default function FooterPage(props) {
	...
	useEffect(() => {
		const fetchVersion = async () => {
			const response = await fetch("https://api.github.com/repos/KnightSoul9/portfolio/contents/package.json");
	...
	return (
		<FooterContainer>
			<div id="grid">
				<BrandFooterWrapper>
					<FooterBrandTextTitle>Satyam Gupta</FooterBrandTextTitle>
				...
				<ScrollAnimation animateIn="fadeIn" animateOnce delay={400}>
					<SectionFooterMenu>
						...
						<FooterTextExternalLink href="https://github.com/KnightSoul9" target="_blank">
							Github
			...
			<ContainerBuildCopyright>
				...
				<span>© {new Date().getFullYear()} All rights reserved to Satyam Gupta</span>
